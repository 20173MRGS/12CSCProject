...
def intquizzer(): # Function that takes input and checks whether it is correct or not for integration quiz #
    ...
    if user_answer == str(str(a) + "x^" + str(b)):
        ...
        print("<incorrect>")
        int_correct_answer.configure(text=("f(x)= " + str(a) + "x^" + str(b)))
...
int_correct_answer = customtkinter.CTkLabel(incorrect_int_screen, text=("f(x)= " + str(a) + "x^" + str(b)))
int_correct_answer.pack(pady=10)
